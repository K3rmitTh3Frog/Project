...
EMAIL_HOST = 'smtp-mail.outlook.com'  # or the correct SMTP server for Outlook
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'project321test@outlook.com'
DEFAULT_FROM_EMAIL = 'project321test@outlook.com'  # This should match EMAIL_HOST_USER
