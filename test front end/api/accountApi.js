...
const BASE_URL = 'http://192.168.0.154:8081/accounts';
...
export const loginWithGitHub = async () => {
  try {
    ...
    // The user completes the login in the browser. Your backend should handle
    // the redirect and possibly send a deep link back to your app with the login status.
